        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {brands.map((brand) => (
                <li key={brand.href}>
                  <Link href={brand.href} className="text-gray-300 hover:text-purple-300">
                    {brand.label}
                  </Link>
                </li>
              ))}
              <li>
                <Link href="/brands" className="text-purple-300 hover:text-purple-400">
                  View All
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              {categories.map((category) => (
                <li key={category.href}>
                  <Link href={category.href} className="text-gray-300 hover:text-purple-300">
                    {category.label}
                  </Link>
                </li>
              ))}
              <li>
                <Link href="/categories" className="text-purple-300 hover:text-purple-400">
                  View All
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-purple-600 text-white px-4 py-1 rounded-md hover:bg-purple-700"
                >
                  Submit
                </button>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/groovygallerydesigns/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-purple-300">
